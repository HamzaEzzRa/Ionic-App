...
import { Patient } from './clients/patient.model';
import { map } from 'rxjs/operators';
import { Physic } from './clients/client-data/physic/physic.model';
import { Prescription } from './clients/client-data/ordonnance/ordonnance.page';
...
export class RequestManagerService {
  ...
  deletePatient(idPatientListChecked: string[]) {
    return this.http.post(
      environment.apiUrl + `/${this.authService.role}/deletePatient`, {
        id: this.authService.userId,
