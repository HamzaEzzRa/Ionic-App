...
[
  ...
  {
    path: 'patient/home/countdown',
    loadChildren: () => import('./auth/sample-countdown/sample-countdown.module').then( m => m.SampleCountdownPageModule),
  ...
  {
    path: 'doctor_coach',
    loadChildren: () => import('./front_end/doctor_coach/tabs/tabs.module').then( m => m.TabsPageModule),
